...
* [faunadb-java](http://fauna.github.io/faunadb-jvm/2.10.0/faunadb-java/api/)
* [faunadb-scala](http://fauna.github.io/faunadb-jvm/2.10.0/faunadb-scala/api/)
...
```scala
libraryDependencies += ("com.faunadb" %% "faunadb-scala" % "2.10.0")
```
