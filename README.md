...
* [faunadb-java](http://fauna.github.io/faunadb-jvm/2.2.0/faunadb-java/api/)
* [faunadb-java-dsl](http://fauna.github.io/faunadb-jvm/2.2.0/faunadb-java-dsl/api/)
...
```scala
libraryDependencies += ("com.faunadb" %% "faunadb-scala" % "2.2.0")
```
